...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-1": ["4.25rem", { lineHeight: "0.95", fontWeight: "500" }],
        "display-2": ["2.5rem", { lineHeight: "1.05", fontWeight: "500" }],
        "display-3": ["1.5rem", { lineHeight: "1.15", fontWeight: "500" }],
        "body-lg": ["1.125rem", { lineHeight: "1.7" }],
        "body-sm": ["0.875rem", { lineHeight: "1.7" }],
        nav: ["0.6875rem", { lineHeight: "1", fontWeight: "600" }],
      },
      letterSpacing: {
        nav: "0.12em",
      },
