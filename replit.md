...
- A hero section with two-line heading ("Your Perfect Home / Discovered"), smooth gradient blend from top of page into navy horizontal bar containing AI description and bold "Live where you belong" subtitle with animated magic wand icon and glittering sparkles, glassmorphism search card over Agent Kammer storefront photo background with gradient overlay for seamless transition.
