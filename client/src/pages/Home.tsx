 ...
 * Contains: Featured Listings, Most Discounted, Longest on Market
 * Can be restored to homepage or reused elsewhere
 */
...
export function ArchivedPropertyListings() {
  ...
  return (
    <>
      <HorizontalPropertyScroll title="Featured Listings" subtitle="Handpicked exceptional homes in Manhattan's most sought-after neighborhoods" properties={featuredProperties} icon={require("lucide-react").Sparkles} />
