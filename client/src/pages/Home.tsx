    ...
    <main className="bg-brand-ivory text-brand-ink">
      <section className="border-b border-brand-border bg-brand-ivory">
        <div className="mx-auto grid w-full max-w-site gap-10 px-6 py-12 lg:grid-cols-[minmax(0,1fr)_minmax(300px,0.72fr)] lg:items-end lg:px-10 lg:py-20">
          <div className="max-w-2xl">
            ...
            <h1 className="ak-display mt-4">Live where you belong</h1>
            ...
            <div className="mt-8">
              ...
              >
                <span className="ak-nav-link text-brand-ivory/72">Guidance Advisor</span>
          ...
          <div className="relative min-h-[280px] overflow-hidden border border-brand-border bg-brand-paper lg:min-h-[420px]">
            <img
            ...
            <div className="absolute inset-x-0 bottom-0 border-t border-brand-ivory/18 p-5 text-brand-ivory">
              <p className="ak-nav-link text-brand-stone">How we think</p>
              <p className="ak-heading mt-2 text-brand-ivory">Life first. Then place.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-brand-border bg-brand-ivory">
        <div className="mx-auto w-full max-w-site px-6 py-16 lg:px-10 lg:py-20">
          ...
          <h2 className="ak-title mt-4 max-w-2xl">Three questions. Then judgment.</h2>
        ...
        <div className="mx-auto w-full max-w-site px-6 py-16 lg:px-10 lg:py-20">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="ak-title mt-4">A clear path through the decision.</h2>
            ...
            <Link
              href="/buyer-advisory"
              className="ak-nav-link inline-flex items-center gap-2 text-brand-navy transition-colors hover:text-brand-navy-secondary"
            >
              Open Start Here
        ...
        <div className="mx-auto w-full max-w-site px-6 py-16 lg:px-10 lg:py-20">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="ak-title mt-4">Start from what changed.</h2>
            </div>
            <Link
          ...
          <div className="mt-10 border-t border-brand-border">
            {featuredBriefs.map((brief) => (
              ...
              >
                ...
                <div>
                  <p className="ak-heading transition-colors group-hover:text-brand-navy-secondary">{brief.navLabel}</p>
        ...
        <div className="mx-auto w-full max-w-site px-6 py-16 lg:px-10 lg:py-20">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="ak-title mt-4">Structure before search.</h2>
            </div>
            <Link
              href="/guides"
              className="ak-nav-link inline-flex items-center gap-2 text-brand-navy transition-colors hover:text-brand-navy-secondary"
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {featuredGuides.map((guide) => (
              <Link
                key={guide.href}
                href={guide.href}
                className="ak-card group p-6 transition-colors hover:border-brand-navy"
              >
                <p className="ak-heading">{guide.title}</p>
                <p className="ak-meta mt-3 line-clamp-2">{guide.description}</p>
                <span className="ak-nav-link mt-5 inline-flex items-center gap-2 text-brand-navy">
                  Open guide
