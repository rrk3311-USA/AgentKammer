  ...
  return (
    <main className="bg-brand-ivory">
      ...
      <article className="mx-auto max-w-[42rem] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <h2 className={`mt-10 ${grammar.section}`}>What we collect</h2>
        ...
        <h2 className={`mt-12 ${grammar.section}`}>How we use it</h2>
        <p className={`mt-4 ${grammar.bodyWide}`}>
        ...
        <h2 className={`mt-12 ${grammar.section}`}>Cookies and sessions</h2>
        <p className={`mt-4 ${grammar.bodyWide}`}>
        ...
        <h2 className={`mt-12 ${grammar.section}`}>Email verification</h2>
        <p className={`mt-4 ${grammar.bodyWide}`}>
        ...
        <h2 className={`mt-12 ${grammar.section}`}>Sharing</h2>
        <p className={`mt-4 ${grammar.bodyWide}`}>
          We may share information with infrastructure providers (hosting, email delivery, analytics) under contract, or with selected local professionals when you authorize a referral. We may disclose information if required by law.
        </p>

        <h2 className={`mt-12 ${grammar.section}`}>Retention and rights</h2>
        <p className={`mt-4 ${grammar.bodyWide}`}>
