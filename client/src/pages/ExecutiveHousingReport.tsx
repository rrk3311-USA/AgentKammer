...
export default function ExecutiveHousingReport() {
  ...
  return (
    <main className="min-h-screen bg-brand-paper text-brand-ink">
      <section className="border-b border-brand-border bg-brand-paper px-6 py-14 lg:px-10 lg:py-20">
      ...
      {relatedPerspective ? (
        <section className="border-t border-brand-border bg-brand-paper px-6 py-14 lg:px-10">
          <div className="mx-auto max-w-3xl">
