      ...
      >
        <defs>
          <linearGradient id="hero-line-metal" x1="0" x2="1" y1="0" y2="1">
            <stop offset="0%" stopColor="#2A3447" stopOpacity="0.22" />
            <stop offset="52%" stopColor="#B08D57" stopOpacity="0.82" />
            <stop offset="100%" stopColor="#2A3447" stopOpacity="0.3" />
          </linearGradient>
        </defs>
...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-brand-border bg-brand-field text-brand-navy">
      {image ? (
        <img
          src={image}
          alt={imageAlt ?? ""}
      ...
      {image ? <div className="absolute inset-0 bg-brand-field/82" /> : null}
      <PageSection className="relative grid gap-12 py-16 lg:grid-cols-[minmax(0,1.02fr)_minmax(320px,0.78fr)] lg:items-end lg:py-24">
        ...
        <div className="space-y-6">
          ...
          <p className="ak-lede max-w-xl">{description}</p>
          {kicker ? (
            <div className="ak-card p-6">{kicker}</div>
          ) : null}
        </div>
      </PageSection>
    </section>
...
export function ReportSubnav() {
  ...
  return (
    <div className="overflow-x-auto border-b border-brand-border bg-brand-field">
...
export function CTA({
  ...
  return (
    <section className="border-t border-brand-border bg-brand-field text-brand-navy">
